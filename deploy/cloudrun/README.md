...
The subsequent background-training update is revision `fly-training-r7812ed676b60`, image `sha256:f2d21866f252d64c3199d43af284e6dfc0b812884c2d155a3270c93d00b735d9`, serving 100% of traffic. It changes only the public client: switching tabs no longer pauses computation or lease renewal. Manual Pause/Stop still work, while hidden previews avoid drawing. The model/config identity and existing Firestore history are preserved; all 15 transport checks passed with three accepted results present after promotion. The [live Safari check](../../reports/flyheaven-tab-background-20260914/safari-background-verification.json) captured advancing simulation frames while the tab was hidden and unpaused.
