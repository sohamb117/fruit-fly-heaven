...
from .topology import initialize_weights, prepare_topology
    ...
    def __init__(self, obs_dim, action_dim, config: ControllerConfig, graph=None):
        ...
        with torch.random.fork_rng(devices=[]):
            ...
            if substrate.kind == "connectome":
                ...
                self.topology = prepare_topology(graph, substrate)
                t = self.topology
                features, self.feature_report = structural_features(t.n, t.src, t.dst, t.weight)
                self.ports = (
                ...
                magnitude, signs, self.initialization_report = initialize_weights(t, substrate)
