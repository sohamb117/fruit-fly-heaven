...
root=Path('/workspace/qualification-isolated-20260918/experiments/connectome_body/runs/learning-qualification-cuda-v2')
...
print('archive_ready',Path(str(root)+'-isolated.tar.gz.sha256').exists())
