...
Hold-last extension: 0.004s, applied only to counterfactual diagnostic runs and explicitly labeled in each sample. Its total-horizon summaries are separate diagnosticTotalMetrics fields. Counterfactual motion would alter sensory input in a live brain; that neural response is not simulated.
