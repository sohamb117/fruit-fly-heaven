...
export const PARAMETER_NAMES=['synapse_exc_log_gain','synapse_inh_log_gain','motor_wing_log_leak','motor_leg_log_leak','motor_probe_log_leak','motor_grip_log_leak','descending_log_leak','sensory_taste_log_gain','sensory_odor_log_gain','sensory_body_log_gain','flight_power_log_gain','flight_deployment_tau_log_scale','flight_frequency_log_scale','flight_steering_bias_log_gain','flight_steering_amplitude_log_gain','muscle_leg_log_gain','muscle_probe_log_gain','muscle_grip_log_gain'];
